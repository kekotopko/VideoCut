...
/**
 * Created by odmen on 20.06.2017.
 */
...
public class AlternativeAspectRatioFrameLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mAspectRatioWidth = a.getInt(R.styleable.AlternativeAspectRatioFrameLayout_aspectRatioWidth, 16);
        mAspectRatioHeight = a.getInt(R.styleable.AlternativeAspectRatioFrameLayout_aspectRatioHeight, 9);
